...
import os
from .levels import LogLevelEnums
...
class LogFactory():
    ...
    def __init__(self,file, log_level=LogLevelEnums.all):
    ...
    def write_log(self,data,level=LogLevelEnums.info):
    ...
    def LOG_LEVELS(level,logger_level):
        levels={
            LogLevelEnums.debug : [LogLevelEnums.debug,LogLevelEnums.warning,LogLevelEnums.error],
            LogLevelEnums.info : [LogLevelEnums.info],
            LogLevelEnums.trace : [LogLevelEnums.warning,LogLevelEnums.error],
            LogLevelEnums.all : [LogLevelEnums.debug,LogLevelEnums.warning,LogLevelEnums.error,LogLevelEnums.info]
        }
